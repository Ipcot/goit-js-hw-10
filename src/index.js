...
function renderOneCountry(payload) {
  ...
  const oneCountry = payload.map(
    country =>
      `<div class="title"><img class="info-img" src="${
        country.flags.svg
      }" alt=""><p class="country">${
        country.name.official
      }</p></div><p class="prop-value"><span class="prop-title">Capital:</span> ${
        country.capital
      }</p><p class="prop-value"><span class="prop-title">Population</span>: ${
        country.population
